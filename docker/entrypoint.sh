...
export PGADMIN_DEFAULT_EMAIL=s50600822@gmail.com
...
if [ ! -f /var/lib/pgadmin/pgadmin4.db ]; then
    ...
    export PGADMIN_SETUP_EMAIL=s50600822@gmail.com
    export PGADMIN_SETUP_PASSWORD=pgadmin
    echo " ${PGADMIN_DEFAULT_EMAIL}  ${PGADMIN_DEFAULT_PASSWORD} ${PGADMIN_DEFAULT_EMAIL}"
